...
# Garfix Stores — متاجر جارفكس 🇰🇼🏗️

> **إعادة براند (المرحلة 1):** كانت «محل شوب» — صارت العلامة الرسمية لمنظومة **Garfix**: منصة المتاجر والتسويق بالعمولة، متكاملة مع **Garfix ERP** (دخول موحد عبر حساب Garfix + فاتورة تلقائية في الـ ERP لكل طلب متجر).
