...
export async function GET() {
  ...
  out.push('');
  out.push(
    `> كل منتجات محل شوب (${total} منتج) بأسعارها بالدينار الكويتي. الدفع عند الاستلام، توصيل ${formatKwd(shipping.price)} د.ك لجميع محافظات الكويت. ملاحظة: على الموقع نفسه، الزائر يشوف أفضل 200 منتج بدون تسجيل — والكتالوج الكامل يفتح بعد التسجيل المجاني من /?view=affiliate-login. كل منتج عليه عمولة مقترحة للمسوّق من 1 إلى 10 د.ك (حر الاختيار) ودراسة تسويقية (سعر بيع مقترح + مستوى الطلب + أنسب قناة إعلانية).`
  );
  out.push('');
