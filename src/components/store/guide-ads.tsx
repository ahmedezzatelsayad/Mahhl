    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['العائد على الإنفاق (ROAS): استهدف 2× فوق تكلفة المنتج — وعمولتنا 1–2 د.ك للطلب تجعل نقطة التعادل سريعة.', 'ROAS: target 2× over product cost — and our 1–2 KWD commission per order lowers your break-even point.'],
        ],
      },
      {
        type: 'callout',
        ar: 'تذكر: عمولتك من 1 إلى 2 د.ك على كل طلب يوصَل تُحسب تلقائياً — يعني كل تحسين صغير في تكلفة الإعلان ينعكس مباشرة على ربحك الصافي.',
        en: 'Remember: your 1–2 KWD commission per delivered order is automatic — every small improvement in ad cost goes straight to your net profit.',
      },
    ],
  },
  {
