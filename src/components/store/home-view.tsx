...
export function HomeView() {
  ...
  const FALLBACK_SLIDES: SliderSlide[] = [
    ...
    },
    {
      ...
      subtitle: 'افتح متجر إلكتروني كامل خلال دقيقة — منتجاتنا جاهزة بنقرة واحدة، إنت تحط هامش ربحك فوق سعر المنصة، وزبائنك يطلبون أونلاين بالدفع عند الاستلام.',
      ...
      subtitleEn: 'Launch a full online store in a minute — add our products with one click, set your margin, and your customers order online with cash on delivery.',
      tone: 'gold',
    ...
    },
    {
      ...
      subtitle: 'طلباتك وزبائنك يوصلون بسرعة لكل محافظات الكويت الست — مع محاسبة عمولات شفافة لحظة بلحظة.',
      ...
      subtitleEn: 'Orders reach every corner of Kuwait fast — with transparent real-time commission accounting.',
      tone: 'blue',
