        ...
        {topProducts.length > 0 && (
          <JsonLd
            data={itemListJsonLd(
              ...
              'الأكثر مبيعاً في متاجر جارفكس'
            )}
          />
        )}
        <div className="sr-only">
          <h1>متاجر جارفكس — منصة دروب شيبنج رقم 1 في الكويت</h1>
          <p>
            متاجر جارفكس أول منصة دروب شيبنج في الكويت: تسويق بالعمولة بأرباح من 1 إلى 2 دينار
            على كل طلب يوصَل من أكثر من 2600 منتج في 38 فئة، مع محاسبة شفافة للمسوّقين.
            وللمتسوقين: أجهزة كهربائية، مستلزمات مطبخ، أحزمة ومشدات، ألعاب، أدوات منزلية، عناية شخصية
    ...
    return (
      <>
        ...
        <article className="sr-only">
          ...
          <p>
            اشترِ {p.name} أونلاين من متاجر جارفكس الكويت بسعر {formatKwd(p.salePrice)} د.ك مع
            خدمة الدفع عند الاستلام والتوصيل السريع. رقم المنتج: {p.sku}.
          </p>
          <a href="/">العودة إلى متاجر جارفكس — الصفحة الرئيسية</a>
        </article>
      </>
    );
  }
    ...
    return (
      <>
        ...
        <section className="sr-only">
          <h1>{c.name} — تسوق أونلاين في الكويت | متاجر جارفكس</h1>
          <p>
            تصفح منتجات {c.name} في متاجر جارفكس. {page.products.length > 0 ? `${page.products.length}+ منتج` : 'منتجات'}{' '}
  ...
  if (page.kind === 'landing') {
    return (
      <div className="sr-only">
        <h1>{page.title}</h1>
        <p>
          {page.title} — عرض خاص من متاجر جارفكس، منصة دروب شيبنج في الكويت. أسعار بالدينار
          الكويتي، دفع عند الاستلام، وتوصيل سريع لجميع المحافظات.
        </p>
        <a href="/">متاجر جارفكس — الصفحة الرئيسية</a>
      </div>
    );
  }
