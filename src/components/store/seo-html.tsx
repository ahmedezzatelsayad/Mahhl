    ...
    return (
      <>
        ...
        <div className="sr-only">
          <h1>محل شوب — منصة دروب شيبنج رقم 1 في الكويت</h1>
          <p>
            محل شوب أول منصة دروب شيبنج في الكويت: تسويق بالعمولة بأرباح من 1 إلى 2 دينار
  ...
  if (page.kind === 'landing') {
    return (
      <div className="sr-only">
        <h1>{page.title}</h1>
        <p>
          {page.title} — عرض خاص من محل شوب، منصة دروب شيبنج في الكويت. أسعار بالدينار
