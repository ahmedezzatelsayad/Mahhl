...
export const DEFAULT_SEO: SeoSettings = {
  ...
  description:
    'محل شوب — أول منصة دروب شيبنج في الكويت. سوّق أكثر من 2600 منتج وكل منتج عليه عمولة مقترحة من 1 إلى 10 د.ك تختارها بمزاجك — بدون رأس مال وبدون هم الشحن، وطلبات عملائك توصلهم بتوصيل سريع لكل المحافظات مع الدفع عند الاستلام.',
  keywords:
...
export async function buildFaqJsonLd(url: string) {
  ...
  const faqs: { q: string; a: string }[] = [
    ...
    {
      q: 'شلون أربح من محل شوب كم مسوّق؟',
...
export async function resolveSeoPage(sp: Record<string, string | string[] | undefined>): Promise<SeoPageData> {
  ...
  const INFO_META: Record<InfoPageKind, { title: string; description: string }> = {
    about: {
      title: 'من نحن — محل شوب منصة دروب شيبنج في الكويت',
      description: 'محل شوب: أول منصة دروب شيبنج في الكويت — أكثر من 2,600 منتج بعمولات مقترحة من 1 إلى 10 د.ك للمسوقين — سجّل مجاناً وافتح الكتالوج الكامل واختر عمولتك بمزاجك.',
    },
    contact: {
    ...
    faq: {
      title: 'الأسئلة الشائعة — تسوق واربح مع منصة محل شوب',
    ...
    terms: {
      title: 'الشروط والأحكام | منصة محل شوب للدروب شيبنج',
      description: 'شروط استخدام منصة محل شوب: الأسعار بالدينار الكويتي، الدفع عند الاستلام، التوصيل لكل محافظات الكويت، وعمولات مسوّقين مقترحة من 1 إلى 10 د.ك تُضاف فوق سعر كل منتج.',
    },
    'affiliate-program': {
      title: 'برنامج المسوقين — سوّق واربح عمولة من 1 إلى 10 د.ك على كل منتج | محل شوب',
      description: 'سجّل مجاناً في برنامج التسويق بالعمولة في محل شوب: أكثر من 2,600 منتج جاهز، عمولة مقترحة من 1 إلى 10 د.ك على كل منتج — وإنت تختار، رابط إحالة خاص فيك, محفظة شفافة وسحب وقت ما تبى — بدون رأس مال وبدون هم الشحن.',
    },
    'guide-ads': {
      title: 'أفضل ممارسات الدعاية والإعلانات في الكويت — مركز المسوقين | محل شوب',
      description: 'دليل شامل للمسوقين في الكويت: قنوات الإعلان الأقوى (سناب شات، تيك توك، إنستقرام)، قواعد الإعلان اللي يبيع، الميزانيات الذكية، والأرقام الواقعية المتوقعة — من منصة محل شوب للدروب شيبنج.',
    },
    'guide-campaigns': {
      title: 'دليل الحملات والمواسم الكويتية للمسوقين | محل شوب',
